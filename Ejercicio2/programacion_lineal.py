from pulp import LpMaximize, LpProblem, LpVariable, LpBinary, PULP_CBC_CMD

def publicity_optimization():
    """
    Fuction to optimize the selection of clients for advertising
    under certain constraints and maximize total profit.
    """
    # Crear el problema
